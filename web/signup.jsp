<%-- 
    Document   : signUp
    Created on : 30-Sep-2022, 12:21:21 pm
    Author     : risha
--%>
        ...
        <script>
            $(document).ready(function () {
                ...
                $("#myform").on('submit', function (event) {
                    event.preventDefault();//Here we are preventing to go to next page.

//                    var f = $(this).serialize();//It will easily send data to server.It will use when you have only text data
